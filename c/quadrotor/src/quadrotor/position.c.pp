...
# 5 "/nfs/stak/students/r/rymalc/usr/include/quadrotor/brain.h" 2
...
# 10 "/nfs/stak/students/r/rymalc/usr/include/quadrotor/brain.h" 2
...
# 12 "/nfs/stak/students/r/rymalc/usr/include/quadrotor/position.h"
class Position {
 public:
  Position(Quadrotor*);
  void reset();
